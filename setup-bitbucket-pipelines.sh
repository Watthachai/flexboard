...
echo "DATABASE_URL_SANDBOX=postgresql://user:pass@host:port/db_sandbox"
echo "JWT_SECRET_SANDBOX=your-jwt-secret-for-sandbox"
echo "CORS_ORIGIN_SANDBOX=https://control-plane-ui-sandbox-xyz.a.run.app"
echo "NEXT_PUBLIC_API_URL_SANDBOX=https://control-plane-api-sandbox-xyz.a.run.app"
echo ""
...
echo "🚦 How to Deploy:"
echo "================="
echo "1. Push to 'dev' branch → deploys to SANDBOX"
echo "2. Merge to 'main' branch → deploys to PRODUCTION"
echo ""
echo "Services will be deployed as:"
echo "- control-plane-ui-sandbox / control-plane-ui"
echo "- control-plane-api-sandbox / control-plane-api"
echo ""
